...
create table t_meeting_topic (
    ...
    report_dept_id varchar(700) comment 'Report department id',
    report_dept_name varchar(500) comment 'Report department name snapshot',
    ...
    summary text comment 'Topic summary',
...
create table t_meeting_attendee (
    ...
    attendee_type varchar(32) not null comment 'LEADER/SHARE/REPORT/PARTAKE',
